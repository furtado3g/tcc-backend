...
jest.mock('fetch');
describe('Entrar e recuperar os tokens da aplicação', function () {
    it('Logar na aplicação', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch(data.url, data.options)];
                case 1:
                    request = _a.sent();
